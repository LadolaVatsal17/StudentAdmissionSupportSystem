 ...
 * @author vvlad
 */
public class studentrequest_comm extends javax.swing.JFrame {
        java.sql.Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    /**
     * Creates new form studentrequest_comm
     */
    public studentrequest_comm() {
        initComponents();
    }
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try {
            ...
            String sql = "SELECT `c_id`, `c_name`, `fee`, `per`, `course`, `state`, `city`, `random` FROM `request_data_12_comm` WHERE `random` = ? ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentrequest_comm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentrequest_comm().setVisible(true);
            }
        });
    }
