 ...
 * @author vvlad
 */
public class studentrequest_12_a extends javax.swing.JFrame {
        java.sql.Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    /**
     * Creates new form studentrequest_12_a
     */
    public studentrequest_12_a() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(932, 463));
        ...
        request.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "College No", "College Name", "College Course", "College Percentile", "Jee", "College Fee", "College State", "College City"
            }
        ));
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try {
            ...
            String sql = "SELECT `c_id`, `c_name`, `fee`, `per`, `jee`, `course`, `state`, `city`, `random` FROM `request_data_12_a` WHERE `random` = ? ";
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        // TODO add your handling code here:
        after12screen hs = new after12screen();
        hs.setVisible(true);
        hs.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentrequest_12_a.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentrequest_12_a().setVisible(true);
            }
        });
    }
