 ...
 * @author vvlad
 */
public class searchbystate_12a extends javax.swing.JFrame {
    ...
    int length;
    /**
     * Creates new form searchbystate_12a
     */
    public searchbystate_12a() {
        initComponents();
        fetchstate();
    }
  ...
  public void quickSort(int lowerIndex, int higherIndex) {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try {
            ...
            String sql = "SELECT `id`, `clgname`, `per`, `jee`, `course`, `clg_fee`, `state`, `city` FROM `info_12_a` WHERE `state` = ? " ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchbystate_12a.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchbystate_12a().setVisible(true);
            }
        });
    }
