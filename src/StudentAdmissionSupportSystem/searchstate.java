...
import StudentAdmissionSupportSystem.after10screen;
/**
 *
 * @author admin
 */
public class searchstate extends javax.swing.JFrame {
  ...
  public void quickSort(int lowerIndex, int higherIndex) {
        ...
        // TODO add your handling code here:
         ...
         sortname.setText("");
           try {
            ...
            String sql = "SELECT `id`, `clgname`, `per`, `course`, `clg_fee`,`state` , `city` FROM `info_10` WHERE `state` = ? " ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchstate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new searchstate().setVisible(true);
            }
        });
    }
