 ...
 * @author vvlad
 */
public class searchstate_b extends javax.swing.JFrame {
    java.sql.Connection con = null;
    PreparedStatement ps = null;
    ResultSet rs = null;
    String names[];
    int length;
    /** Creates new form searchstate_b */
    public searchstate_b() {
        initComponents();
        fetchstate();
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(sort)
                .addGap(101, 280, Short.MAX_VALUE))
...
private void fetchstate()
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try {
            ...
            String sql = "SELECT `id`, `clgname`, `per`, `neet`, `course`, `clg_fee`, `state`, `city` FROM `info_12_b` WHERE `state` = ? " ;
            ...
            while(rs.next())
            {
                ...
                sortname.append(cname+"\t"+ccourse+"\t"+clg_fee+"\t"+cper+"\t"+cjee+"\t" +cstate+"\t"+ccity+"\n");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchstate_b.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchstate_b().setVisible(true);
            }
        });
    }
