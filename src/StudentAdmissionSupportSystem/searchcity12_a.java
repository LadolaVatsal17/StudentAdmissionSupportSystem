 ...
 * @author vvlad
 */
public class searchcity12_a extends javax.swing.JFrame {
    ...
    int length;
    /**
     * Creates new form searchcity12_a
     */
    public searchcity12_a() {
        initComponents();
        fetchcity();
    }
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try {
            ...
            String sql = "SELECT `id`, `clgname`, `per`,`jee`, `course`, `clg_fee`,`state` , `city` FROM `info_12_a` WHERE `city` = ? " ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchcity12_a.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchcity12_a().setVisible(true);
            }
        });
    }
